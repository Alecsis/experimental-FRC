...
- `refactor/hybrid` is unchanged at `1430d1c`, exactly 16 commits behind `codex` (13 Codex, 3 review). The merge is deliberately held: it would carry all 16, including the remaining flagged item below. Verified clean fast-forward when approved.
