...
public class Telemetry {
    ...
    public Telemetry(double maxSpeed) {
        MaxSpeed = maxSpeed;
        SignalLogger.start();
        SmartDashboard.putData("Swerve Drive", new SwerveSendable());
    }
    ...
    public void telemeterize(SwerveDriveState state) {
        /* Update last state for Elastic swerve widget */
        m_lastState = state;
        ...
        Logger.recordOutput("SwerveStates/Setpoints", state.ModuleTargets);
    ...
    private class SwerveSendable implements Sendable {
        @Override
        public void initSendable(SendableBuilder builder) {
            builder.setSmartDashboardType("SwerveDrive");
            builder.addDoubleProperty("Front Left Angle",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[0].angle.getRadians() : 0, null);
            builder.addDoubleProperty("Front Left Velocity",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[0].speedMetersPerSecond : 0,
                    null);
            builder.addDoubleProperty("Front Right Angle",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[1].angle.getRadians() : 0, null);
            builder.addDoubleProperty("Front Right Velocity",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[1].speedMetersPerSecond : 0,
                    null);
            builder.addDoubleProperty("Back Left Angle",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[2].angle.getRadians() : 0, null);
            builder.addDoubleProperty("Back Left Velocity",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[2].speedMetersPerSecond : 0,
                    null);
            builder.addDoubleProperty("Back Right Angle",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[3].angle.getRadians() : 0, null);
            builder.addDoubleProperty("Back Right Velocity",
                    () -> m_lastState.ModuleStates != null ? m_lastState.ModuleStates[3].speedMetersPerSecond : 0,
                    null);
            builder.addDoubleProperty("Robot Angle",
                    () -> m_lastState.Pose != null ? m_lastState.Pose.getRotation().getRadians() : 0, null);
        }
    }
}